#python development internship | Task-2 Receipt calculator ---

print("- Welcome to our Restaurant -")
# Get input from the user
num_people = int(input("How many People are in your Group? :"))
# Ask user to choose a currency
currency = input("Choose a currency between $ or INR: ")

# Check if the currency is valid
while currency != '$' and currency != 'INR':
    print("Warning: Invalid currency selected. Please choose either $ or INR.")
    currency = input("Choose a currency between $ or INR: ")
...
print("Thank you for visiting our restaurant! We hope you enjoyed your Food.")